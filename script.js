...
You can find the source code at <a href="https://www.youtube.com/redirect?q=https://iamtarek.is-a.dev" style="font-family:monospace;" > https://iamtarek.is-a.dev</a>
<br><br></p><br><br><br>
...
<z style="margin-left:6px">by Tarek Hossain</z>
</div>
`;
...
var actionsList={
  follow:()=>{
    Android.oplink("https://iamtarek.is-a.dev");
  },
  hearts:()=>{
  ...
  issues:()=>{
    Android.oplink('https://iamtarek.is-a.dev/issues');
  },
  disableCodecs:()=>{
...
x.addEventListener("click",(e)=>{
  ...
  if(action == "url"){
    Android.oplink('https://iamtarek.is-a.dev/releases');
